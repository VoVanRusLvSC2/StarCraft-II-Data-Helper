...
struct OptimizationPlanData
{
    ...
    QVector<OptimizationPlanRow> importCleanup;
...
public:
    ...
    void recordImportCleanupResult(int changed);
...
private:
    ...
    QTableWidget *m_importCleanup = nullptr;
